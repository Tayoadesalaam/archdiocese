...
from app.routers import auth, events, users, parishes, sacraments, announcements, priests  # Add priests here
...
app.include_router(priests.router, prefix="/api")  # Add this line
